...
class WrappedPoisson:
    ...
    def get_log_likelihood(self, obs):
        return xgstats.poisson_log_pmf(obs, self.expectation)
    def get_likelihood(self, obs):
        return math.exp(xgstats.poisson_log_pmf(obs, self.expectation))
...
class SinglePatternState:
    ...
    def get_log_likelihood(self, obs):
        ...
        accum += xgstats.multinomial_log_pmf(self.distribution, obs)
        return accum
    def get_likelihood(self, obs):
